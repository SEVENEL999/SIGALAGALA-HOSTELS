...
function init3DScene() {
    ...
    // FIXED: Dynamic path routing ensures the file resolves correctly inside GitHub subfolders
    const modelPath = window.location.pathname.includes('SIGALAGALA-HOSTELS') 
        ? './autumn_house.glb' 
        : 'autumn_house.glb';
...
function hidePreloader() {
    ...
    if (loader) {
        // FIXED: Explicit structural styling bypasses background dependency race conditions instantly
